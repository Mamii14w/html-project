   ...
   if (isset($_POST['submit']))
                            {
                                ...
                                $sql="insert into course  values('','$c_code','$c_name','$credit_hour',$dept,'$year',$term)";
                                
                              if(mysqli_query($con,$sql))
                                                    {
                                    $_SESSION['msg']="Course Added Succesfuly";
                                     header("location:manage_course.php");
                                                    }
                                 else
                                    {
                                   $_SESSION['msg']="Course Does Not Added";
                                   header("location:manage_course.php");
                                    }
                                }
                   ?>
 ...
 <table border="0" width="1280px" bgcolor="lightgrey" align="center"  >
    ...
    <tr>
      ...
      <form  method='POST' action="<?= $_SERVER["PHP_SELF"];?>" enctype="multipart/form-data">
                ...
                <tr bgcolor="lightblue"><td colspan=2 align=center><font color=black> Course Adding Form
                </td></tr>
                
                <tr><td>Course Code :</td><td><input class="form-control" type="text" name="c_code" placeholder='course code' required pattern=[a-zA-Z0-9]{5,15} required=""oninvalid="this.setCustomValidity('Please enter valid course code')"oninput="setCustomValidity('')"></td></tr>
                <tr><td>Course Name </td><td><input class="form-control" type="text"   name="c_name" placeholder='Course Title' required pattern=[a-zA-Z ]{1,40} required=""oninvalid="this.setCustomValidity('Please enter valid course name')"oninput="setCustomValidity('')"></font></td></tr>
                <tr><td>Credit Hour </td><td><input class="form-control" type="number" min="1"max="36"  name="c_hr" placeholder='Credit Hour' required pattern=[0-9]{1,2} required=""oninvalid="this.setCustomValidity('Please enter valid course credit hour')"oninput="setCustomValidity('')"></font></td></tr>

            <tr><td> Department:</td><td><input type="text" class="form-control" name="dept_id" value='<?php echo $rowdd['dept_name'];?>' readonly>

                            </td>
                   </tr>
            <tr><td> Year: </td><td><select  class="form-control" name="year" required="oninvalid='this.setCustomValidity('Please select year')"oninput="setCustomValidity('')">
                                    <?php
                ...
                <tr><td> Term: </td><td><select  class="form-control" name="sem" required="oninvalid='this.setCustomValidity('Please select term')"oninput="setCustomValidity('')">
                                    <?php
                ...
                <tr><td colspan="2" align="center"><input id="btn" class="btn btn-success" type='submit' value='Add' name='submit' Onclick="return check(this.form);"/>
