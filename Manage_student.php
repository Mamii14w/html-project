...
<body >
 <table border="0" width="1280px" bgcolor="lightgrey" align="center"  >
     ...
     <td style="padding-bottom: 100px;">
       ...
       <!-- <a style="margin-top: 10px;" class="btn btn-success" href="crt_staff_account.php" > +Add </a> <font size="4" face="monotype corsiva"  style="font-weight: bold; margin-top: 50px">students </font>  -->
        ...
        ?>
         ...
         <table class="table table-striped table-bordered table-hover" border="1" style="top: 0; margin-top: 20px; margin-left: -80px;">
            ...
            <tr>
                ...
                <th class="t_th" width="30px"> Defualt password </th>
            ...
            <th class="t_th" width="100px">Action</th>
              ...
              <?php
              include('connection.php');
                $sql="SELECT *FROM student_account INNER JOIN student ON student_account.student_id=student.stud_id";
                $res=mysqli_query($con,$sql);
              ...
              if($rows['Status']==1)
                    {
                        ...
                        echo"<td ><a class='btn btn-success' href = 'deactive_student.php?enable=".$id."'>
                        <span  title='disable' onclick='isendis();'>Activated</span></a></td>";
                    }
                    else if($rows['Status']==0)
                    {
                       echo"<td style='height:30px;' align = 'center' width = '1'><a class='btn btn-warning' href = 'active_student.php?disable=".$id."'>
             ...
             <td><a href="update_student.php?s_id=<?php echo $rows['id'];?>" title="Edit student Details"><i class="fa fa-edit fa-1x"></i></a></td>
             
              <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_student.php?s_id={<?php echo $rows['id'];?>" title="delete student"><i class="fa fa-trash fa-1x"></i></a></td>
              <?php
               $num++;
                }
                   }
