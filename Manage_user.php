...
<body >
 <table border="0" width="1280px" bgcolor="lightgrey" align="center"  >
     ...
     <td style="padding-bottom: 100px;">
        ...
        <a style="margin-top: 10px;" class="btn btn-success" href="crt_user_account.php" > +Add </a> <font size="4" face="monotype corsiva"  style="font-weight: bold; margin-top: 50px">Users </font>
         ...
         <table class="table table-striped table-bordered table-hover" border="1" style="top: 0; margin-top: 20px; margin-left: -80px;">
            <tr>
                <td colspan="11">
                   ...
                   ?>
                  <font style="font-weight: bold; font-size: 20; font-family: italic;">Users:  <?php  echo "$count" ?></font>
                </td>
            </tr>
            <tr>
            ...
            <th class="t_th" width="100px">Action</th>
              ...
              <?php
              include('connection.php');
                $sql="SELECT *FROM user_account INNER JOIN user ON user_account.user_id=user.u_id";
                $res=mysqli_query($con,$sql);
              ...
              if($rows['status']==1)
                    {
                        ...
                        echo"<td ><a class='btn btn-success' href = 'deactivate_user.php?enable=".$id."'>
                        <span  title='disable' onclick='isendis();'>Activated</span></a></td>";
                    }
                    else if($rows['status']==0)
                    {
                       echo"<td style='height:30px;' align = 'center' width = '1'><a class='btn btn-warning' href = 'activate_user.php?disable=".$id."'>
          ...
          <!--  echo "<td> <a onClick=\" javascript:return confirm('Are you sure to delete')\" 
                class='btn btn-danger' href='delete_user.php?u_id={$rows['u_id']}'> Delete</a>" 
               ."</td>";
             
             echo "<td ><a class='btn btn-warning' href='update_user.php?u_id={$rows['u_id']}'> Edit</a>" ."</td>";-->
              <td><a href="update_user.php?u_id=<?php echo $rows['id'];?>" title="Edit student Details"><i class="fa fa-edit fa-1x"></i></a></td>
              <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_user.php?u_id={<?php echo $rows['id'];?>" title="delete student"><i class="fa fa-trash fa-1x"></i></a></td>
             <?php
             $num++;
