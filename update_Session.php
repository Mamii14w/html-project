...
$query = mysqli_query($con,"SELECT * FROM session WHERE id='$_SESSION[editid]'");
...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"UPDATE session SET session_name='$sessionName' WHERE id='$_SESSION[editid]'");
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="" name="sessionName" type="tel" class="form-control cc-exp" value="<?php echo $rowi['session_name'];?>" placeholder="Session Name">
                                                    </div>
                                                </div>
                                                    </div>
                                                    <div>
