...
<?php 
           ...
           if(isset($_SESSION["username"])) 
        {
            ...
            die(header('location:login.php'));
                       ...
                       $updated_id = $_GET['u_id'];

       $sqll="SELECT * FROM user WHERE u_id ='".$updated_id."' ";

       $res=mysqli_query($con,$sqll);

       $rows=mysqli_fetch_array($res); 

       $sql1="SELECT * FROM user_account WHERE user_id ='".$updated_id."' ";
       ...
       $rows2=mysqli_fetch_array($ress);   
        ...
        $sql= mysqli_query($con,"UPDATE user SET Fname = '$first_name', Lname = '$last_name', sex='$sex', DOB='$age', Pnumber='$phone', Email='$email' WHERE u_id='$id'") or die(mysqli_error($con));
        $sql1=mysqli_query($con, "UPDATE user_account SET Role='$role' WHERE user_id='$id'") or die(mysqli_error($con));

       if($sql && $sql1) {

       $_SESSION['msg']="User Updated Succesfuly";
       header("location:Manage_user.php");
         }
       else
       {
           $_SESSION['msg']="User data Does Not Updated";
           header("location:Manage_user.php");
      }  
    ...
    <tr>
     ...
     <td >
                        ...
                        <tr><td>First Name :</td><td><input  type="text" class="form-control" name="fname"  value="<?php echo"{$rows['Fname']}" ?>" required></td></tr>
                         <tr><td><input  type="hidden" name="id"  value="<?php echo"{$rows['u_id']}" ?>"></td></tr>
                        ...
                        <tr><td>Role:</td><td><select class="form-control"  name="role" required>
                                    ...
                                    <option>Associated Directorate</option>
