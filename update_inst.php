            ...
            die(header('location:login.php'));
              ...
              $req = mysqli_query($con,"SELECT *FROM staff WHERE s_id = $staff_id");
               ...
               $rowdd = mysqli_fetch_array($rse); 
                       ...
                       $updated_id = $_GET['inst_id'];


       $res=mysqli_query($con, "SELECT * FROM staff WHERE s_id ='".$updated_id."' ");
 ...
 <table width="1280px" bgcolor="lightgrey" align="center" style="top: 0;" >
    ...
    <tr>
     ...
     <td >
                        ...
                        <tr bgcolor="lightblue"><td height="50px" colspan=3 align=center><font color=black> Update Information Form
                        </td></tr>
