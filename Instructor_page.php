...
<body>
 <table border="0" width="1280px" bgcolor="lightgrey" align="center"  >
    ...
    <tr>
       ...
       <ul>
           <li class="li"><a class="btn btn-default" href="Instructor_page.php"> Home</a></li>
           <li class="li">Instructor page</li>
    ...
    <tr>
        <td height="400px" colspan="2">
           <?Php 
              include('Side_bar_instructor.php');
           ?>
     </td>
        ...
        <?php
         include('connection.php');
           ...
           if (isset($_SESSION["staff_id"])) {
            ...
            $sql = mysqli_query($con,"SELECT *FROM staff WHERE s_id = '$staffid' ");
